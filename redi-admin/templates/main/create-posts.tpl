...
<div class="row top-buffer">
    <h3 class="page-header" style="margin-top:0 !important;">Create Post</h3>
    <div class="col-md-8">    
        <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><input type="text" class="form-control create-input" name="title" placeholder="Posts Title"></h3>
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                <select name="category" id="category" class="btn btn-lg btn-default" style="width:100% !important; margin-bottom:5px;">
                    <?php
