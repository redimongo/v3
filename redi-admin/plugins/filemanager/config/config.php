...
$upload_dir = '/redi-upload/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../redi-upload/'; // relative path from filemanager folder to upload folder (with final /)
